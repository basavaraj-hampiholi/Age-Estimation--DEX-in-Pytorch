...
def main():
    ...
    #Loading the data
    transformed_train_dataset = AgeEstimationDataset(csv_file='imdb/IMDB_Wiki_Train.csv',
                                           root_dir='imdb/',
    ...
    transformed_valid_dataset = AgeEstimationDataset(csv_file='imdb/IMDB_Wiki_Val.csv',
                                           root_dir='imdb/',
                                           transform=transforms.Compose([
                                           Rescale(256),
                                           RandomCrop(224),
    ...
    train_loader =  torch.utils.data.DataLoader(transformed_train_dataset, batch_size=8,
                                               shuffle=True, num_workers=8)

    val_loader =  torch.utils.data.DataLoader(transformed_valid_dataset, batch_size=8,
                                               shuffle=True, num_workers=8)
...
def save_checkpoint(state, is_best, epoch, filename='checkpoint.pth.tar'):
    ...
    if is_best and epoch % 5 == 0: 
        shutil.copyfile(filename, 'model_best.pth.tar_'+str(epoch))
