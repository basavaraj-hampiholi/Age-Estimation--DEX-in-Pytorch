...
def main():
    ...
    transformed_test_dataset = AgeEstimationDataset(csv_file='imdb/IMDB_Wiki_Adience_Test.csv',
                                           root_dir='imdb/',
...
def test(val_loader, model, criterion):
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        #print('@prec5 {0}\t' 'Target {1}'.format(prec5,target))
...
def accuracy(output, target, topk=(1,)):
    ...
    prob,label= torch.topk(output, 100)
    #Expected value
